  ...
  if (!settings) {
    await prisma.siteSettings.create({
      data: {
        ...
        seoTitle: 'Cơm Thị Nở | Quán Cơm Văn Phòng Hà Đông Chuẩn Bắc Bộ',
        seoDescription: 'Cơm Thị Nở - quán cơm ngon Văn Quán Hà Đông, phục vụ cơm văn phòng, cơm gia đình, cơm mang về và đặt tiệc chuẩn vị Bắc Bộ mỗi ngày tại Nguyễn Khuyến.',
        seoKeywords: 'Cơm Văn Quán, Cơm Hà Đông, Cơm Bắc Bộ, Cơm văn phòng Hà Đông, Quán cơm ngon Hà Đông, Cơm gia đình Hà Đông, Cơm mang về Hà Đông, Cơm Thị Nở',
